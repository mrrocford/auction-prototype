...
class Lot(models.Model):
    ...
    lot_category = models.ForeignKey(
        LotCategory, on_delete=models.CASCADE, default=1)
    lot_viewimage = models.ForeignKey(
        LotImage, on_delete=models.CASCADE, related_name="imagelot", default=1)
    lot_bid = models.ForeignKey(
        Bid, on_delete=models.CASCADE, related_name="lotbid", default=1)
